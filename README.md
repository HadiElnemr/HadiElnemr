...
a Doctoral candidate at the [Cyber-Physical Systems group](https://www.ce.cit.tum.de/ce/forschung/professuren/hncps/), TUM Heilbronn Campus. Research is under the supervision of [Prof. Amr Alanwar](https://sites.google.com/view/amr-alanwar/) on Discrete Reachability Analysis and its applications.
...
Did my master's thesis at the [Institut für Systemtheorie und Regelungstechnik (IST)](https://www.ist.uni-stuttgart.de/) under the supervision of M.Sc. Fabian Jakob where the title is "**_Improved Automated Generation of Tracking Bounds for First-Order Algorithms in Time-Varying Optimisation_**".
